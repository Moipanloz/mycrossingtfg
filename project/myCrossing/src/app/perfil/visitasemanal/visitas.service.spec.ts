...
describe('Visitas', () => {
  ...
  it('should not create again', async () =>{
    let parametrosCreate = new HttpParams()
      ...
      expect(await (await http.get("http://localhost/php/visita.php", { params: parametrosCreate, responseType: 'blob' } ).toPromise()).text()).toEqual("La visita ya existe");
      let res2: Visita[];
      res2 = JSON.parse(await (await http.get("http://localhost/php/visita.php", { params: parametrosRead, responseType: 'blob' } ).toPromise()).text());
      expect(res2).toBeTruthy();
      expect(res2[0].usuario_id.toString()).toEqual('2');
  ...
  it('should not create wrong user', async () =>{
    let parametrosCreate = new HttpParams()
      ...
      expect(await (await http.get("http://localhost/php/visita.php", { params: parametrosCreate, responseType: 'blob' } ).toPromise()).text()).toEqual("No existe el usuario");
  });
  it('should not create wrong verif', async () =>{
    let parametrosCreate = new HttpParams()
      ...
      .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.get("http://localhost/php/visita.php", { params: parametrosCreate, responseType: 'blob' } ).toPromise()).text()).toEqual("Código de verificacion incorrecto");
  });
  ...
  it('should not read wrong user', async () =>{
      ...
      expect(await (await http.get("http://localhost/php/visita.php", { params: parametrosRead, responseType: 'blob' } ).toPromise()).text()).toEqual("No existe el usuario");
  });
  it('should not read wrong verif', async () =>{
      let parametrosRead = new HttpParams()
        ...
        .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.get("http://localhost/php/visita.php", { params: parametrosRead, responseType: 'blob' } ).toPromise()).text()).toEqual("Código de verificacion incorrecto");
  });
  ...
  it('should not update object from another user', async () =>{
    let visita:Visita = {usuario_id:'1',estela:true,lpa:'lpa',mpa:'mpa',xpa:'xpa',jpa:'jpa',vpa:'vpa',lpr:'lpr',mpr:'mpr',xpr:'xpr',jpr:'jpr',vpr:'vpr',last_update:null};
      let parametrosUpdate = new HttpParams()
        ...
        .set("verif", verificationService.verifCode)
        .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosUpdate, responseType: "blob"} ).toPromise()).text()).toEqual("Esta visita no le pertenece");
  });
  it('should not update estela null', async () =>{
    let visita:Visita = {usuario_id:'2',estela:null,lpa:'lpa',mpa:'mpa',xpa:'xpa',jpa:'jpa',vpa:'vpa',lpr:'lpr',mpr:'mpr',xpr:'xpr',jpr:'jpr',vpr:'vpr',last_update:null};
      let parametrosUpdate = new HttpParams()
        ...
        .set("verif", verificationService.verifCode)
        .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosUpdate, responseType: "blob"} ).toPromise()).text()).toEqual("Debe especificar correctamente si estela ha ido de visita");
  });
  ...
  it('should not update wrong user', async () =>{
    let visita:Visita = {usuario_id:'9999',estela:true,lpa:'lpa',mpa:'mpa',xpa:'xpa',jpa:'jpa',vpa:'vpa',lpr:'lpr',mpr:'mpr',xpr:'xpr',jpr:'jpr',vpr:'vpr',last_update:null};
      let parametrosUpdate = new HttpParams()
        ...
        .set("verif", verificationService.verifCode)
        .set("userId", JSON.stringify(9999));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosUpdate, responseType: "blob"} ).toPromise()).text()).toEqual("No existe el usuario");
  });
  it('should not update wrong verif', async () =>{
    let visita:Visita = {usuario_id:'2',estela:true,lpa:'lpa',mpa:'mpa',xpa:'xpa',jpa:'jpa',vpa:'vpa',lpr:'lpr',mpr:'mpr',xpr:'xpr',jpr:'jpr',vpr:'vpr',last_update:null};
      let parametrosUpdate = new HttpParams()
        ...
        .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosUpdate, responseType: "blob"} ).toPromise()).text()).toEqual("Código de verificacion incorrecto");
  });
    ...
    let visita:Visita = {usuario_id:'1',estela:true,lpa:null,mpa:null,xpa:null,jpa:null,vpa:null,lpr:null,mpr:null,xpr:null,jpr:null,vpr:null,last_update:'9999'};
      let parametrosFecha = new HttpParams()
        ...
        let parametrosRead = new HttpParams()
          ...
          .set("verif", verificationService.verifCode)
          .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosFecha, responseType: "blob"} ).toPromise()).text()).toEqual("Esta visita no le pertenece");
  });
    ...
    let visita:Visita = {usuario_id:'9999',estela:true,lpa:null,mpa:null,xpa:null,jpa:null,vpa:null,lpr:null,mpr:null,xpr:null,jpr:null,vpr:null,last_update:'9999'};
      let parametrosFecha = new HttpParams()
        ...
        let parametrosRead = new HttpParams()
          ...
          .set("verif", verificationService.verifCode)
          .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosFecha, responseType: "blob"} ).toPromise()).text()).toEqual("No existe el usuario");
  });
    ...
    let visita:Visita = {usuario_id:'2',estela:true,lpa:null,mpa:null,xpa:null,jpa:null,vpa:null,lpr:null,mpr:null,xpr:null,jpr:null,vpr:null,last_update:'9999'};
      let parametrosFecha = new HttpParams()
        ...
        let parametrosRead = new HttpParams()
          ...
          .set("verif", verificationService.verifCode)
          .set("userId", JSON.stringify(verificationService.user));
      expect(await (await http.put("http://localhost/php/visita.php", visita, { params: parametrosFecha, responseType: "blob"} ).toPromise()).text()).toEqual("Código de verificacion incorrecto");
  });
});