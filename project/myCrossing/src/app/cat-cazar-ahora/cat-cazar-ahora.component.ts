...
@Component({
  selector: 'app-cat-cazar-ahora',
  templateUrl: './cat-cazar-ahora.component.html',
  styleUrls: ['./cat-cazar-ahora.component.css']
})
export class CatCazarAhoraComponent implements OnInit {
  ...
  cambiaCategoria(categoria : string){
    if(this.categoria!=categoria){
      ...
      this.shownCreature = creatures.filter(i => i.sourceSheet == "Fish")[0];
    }
  }
